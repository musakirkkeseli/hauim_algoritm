...
public class XAlgoHAUIMHC {
	...
	/** map of items to their AUUB values */
	Map<Integer, Integer> mapItemToAUUB;

	/** another map of items to their AUUB */
	Map<Integer, Integer> mapItemToAUUB0;

	/** the items which has auub value more than minUtil */
	List<Integer> auubPattern;//
	...
	/** the portation of auub value of each */
